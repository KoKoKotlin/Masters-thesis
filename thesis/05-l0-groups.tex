...
This result allows us in the main results of the thesis to only talk about the simple function because the extrem amenability property is inherited by $L_0(\mu, G)$ from them.
