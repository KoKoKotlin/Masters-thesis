...
\nomenclature{$\emptyset$}{The empty set}
...
\nomenclature{$\PowSF(X)$}{The set of all \textbf{finite} subsets of $X$}
...
\nomenclature{$\mathcal{N}_x$}{The set of all open sets in a top. space $X$ containing the element $x \in X$}
